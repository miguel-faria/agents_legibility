...
if [ "$env_type" = "conda" ]; then
  ...
  if [ "$cuda_version" = 11 ]; then
    mamba install -y -c conda-forge numpy==1.24.3 ml_dtypes==0.1.0 scipy matplotlib pandas sympy nose pyyaml termcolor rich scikit-learn opencv
    ...
    mamba install -y -c conda-forge numpy scipy matplotlib pandas sympy nose pyyaml termcolor rich scikit-learn opencv
    mamba install -y -c conda-forge stable-baselines3 tensorboard wandb gymnasium pygame
  ...
  if [ "$cuda_version" = 11 ]; then
    python3 -m pip install numpy==1.26.4 ml_dtypes==0.1.0 scipy matplotlib ipython jupyter pandas sympy nose pyyaml termcolor rich scikit-learn opencv-python gym pyglet==1.5.29
    ...
    python3 -m pip install numpy scipy matplotlib ipython jupyter pandas sympy nose pyyaml termcolor rich scikit-learn opencv-python gym pyglet==1.5.29
