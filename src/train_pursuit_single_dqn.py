...
def main():
	...
	if tracker_dir == '':
		tracker_dir = log_dir
	log_filename = (('train_pursuit_single%s_%s-prey_dqn_%dx%d-field_%d-hunters_%d-preys' %
					 ('_vdn' if use_vdn else '', prey_type, field_size[0], field_size[1], n_hunters, n_preys)) +
