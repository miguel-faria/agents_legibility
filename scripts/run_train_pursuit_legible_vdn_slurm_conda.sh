...
if [ "$HOSTNAME" = "artemis" ] || [ "$HOSTNAME" = "poseidon" ] || [ "$HOSTNAME" = "maia" ]  ; then
  python "$script_path"/run_train_pursuit_legible_vdn_dqn.py --field-len 10 --hunters 2 --catch-reward 5 --prey-type random --batch-size 64 --buffer-size 100000 --iterations 40000 --episode-steps 800 --warmup 800 --limits 1 1 --eps-type linear --eps-decay 0.25 --start-eps 1.0 --legible-reward q_vals --beta 0.9 --legibility-temp 0.1 --online-lr 0.00005 --use-lower-curriculum --logs-dir /mnt/scratch-artemis/miguelfaria/logs/pursuit --models-dir /mnt/data-artemis/miguelfaria/deep_rl/models --data-dir /mnt/data-artemis/miguelfaria/deep_rl/data
  ...
  python "$script_path"/run_train_pursuit_legible_vdn_dqn.py --field-len 10 --hunters 2 --catch-reward 5 --prey-type random --batch-size 64 --buffer-size 100000 --iterations 40000 --episode-steps 800 --warmup 800 --limits 1 1 --eps-type linear --eps-decay 0.25 --start-eps 1.0 --legible-reward q_vals --beta 0.9 --legibility-temp 0.1 --online-lr 0.00005 --use-higher-curriculum
fi
